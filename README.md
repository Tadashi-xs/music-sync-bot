...
- Выбор исходной платформы (Spotify, VK Музыка)
...
### Начало работы
- Команда `/start` → приветствие + кнопка `Начать синхронизацию`
- Краткое описание возможностей Telegram-бота

### Выбор исходной платформы
- Клавиатура с кнопками: `Spotify`, `VK Музыка`
